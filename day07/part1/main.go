...
func main() {
	example_input := read_input("./day07/part1/inputs/example_input.txt")
	example_total := part1(example_input)
	log.Printf("Example total: %v\n", example_total)

	input := read_input("./day07/part1/inputs/input.txt")
	total := part1(input)
	log.Printf("Total: %v\n", total)
}
...
func is_valid_equation(desired_result int64, numbers []int64, current_result int64, index int) bool {
	...
	return is_valid_equation(desired_result, numbers, current_result+numbers[index], index+1) || is_valid_equation(desired_result, numbers, current_result*numbers[index], index+1)
}
